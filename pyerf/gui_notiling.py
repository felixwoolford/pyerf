...
class VisualTab(pqtw.QWidget):
    ...
    def layout_frames(self, layout):
        if layout == "square":
            ...
            self.parent().qtab.setMinimumSize(self.mf.core.full_size, self.mf.core.full_size)
        elif layout == "pair":
            self.new_visual_frame(None, size = (self.mf.core.full_size,
                self.mf.core.full_size), pos = (0,0,6,6))
            self.new_visual_frame(None, size = (self.mf.core.full_size,
                self.mf.core.full_size), pos = (0,6,6,6))
            self.parent().qtab.setMinimumSize(self.mf.core.full_size*2, self.mf.core.full_size)
        ...
        self.parent().setMinimumSize(self.mf.qtab.size())
